 ...
 * @Last Modified time: 2020-02-25 15:18:30
*/
package main
...
func testField() {
	testInt := 200
	fmt.Println("testInt =", testInt) // 函数中优先使用局部变量
}
...
// 闭包3
func calc0(base int) (func(int) int, func(int) int) {
	add := func(i int) int {
		base += i
		return base
	}
